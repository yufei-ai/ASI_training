...
learning_rate = 2
updates = [
        [W_xh, W_xh - learning_rate * T.grad(cost, W_xh)], 
        [b_xh, b_xh - learning_rate * T.grad(cost, b_xh)],
        [W_hy, W_hy - learning_rate * T.grad(cost, W_hy)], 
        [b_hy, b_hy - learning_rate * T.grad(cost, b_hy)],
    ]
